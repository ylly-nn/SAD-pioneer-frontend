...
import {
  HomeRoute,
  ProtectedRoute,
  ProtectedRouteNoOrganizations,
  ProtectedRouteOrganizations,
  ProtectedRouteOrganizationsRequest,
      ...
      <Router future={{ v7_relativeSplatPath: true, v7_startTransition: true }}>
        <Routes>
          ...
          <Route path="/organization">
            ...
            />
            <Route
              path="branch/:id/service/:serviceId"
              element={
                <ProtectedRouteOrganizations>
                  {" "}
                  <ServiceDetailPage />{" "}
